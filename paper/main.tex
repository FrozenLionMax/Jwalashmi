...
\author{\textbf{Ayush Kushwaha} \\[4pt] \textit{with} \textbf{Khushi Pandey}}
...
\begin{tabular}{@{}lllrl@{}}
\toprule
Study & Data Source & Method & M-class AUC & Notes \\
\midrule
Bobra \& Couvidat (2015) & SDO/HMI & SVM & 0.90 & 25 magnetogram features \\
Bloomfield et al.\ (2012) & GOES & Poisson/CLV & --- & TSS = 0.53 \\
Nishizuka et al.\ (2017) & SDO+GOES & Deep Flare Net & 0.88 & Multi-wavelength images \\
...
Ma et al.\ (2024) & SDO+GOES & JW-Flare & 0.95 & Multimodal, TSS = 0.95 \\
\midrule
\textbf{Jwalashmi (ours)} & \textbf{Aditya-L1 + GOES} & \textbf{CNN-Attn Ensemble} & \textbf{0.997} & \textbf{9 physics features} \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{table}[htbp]
\centering
\caption{Aditya-L1 data summary and balanced dataset composition.}
\label{tab:data}
\footnotesize
\begin{tabular}{@{}llll@{}}
\toprule
...
\label{tab:features}
\footnotesize
\begin{tabular}{@{}clp{1.6cm}l@{}}
\toprule
\# & Feature & Source & Physics \\
\midrule
1 & derivative & SoLEXS & Energy release rate \\
2 & roll\_max\_ratio & SoLEXS & Relative intensity \\
...
9 & spec\_hardness & HEL1OS & Spectral index \\
\bottomrule
\end{tabular}
\end{table}
...
The author thanks Khushi Pandey for valuable contributions to the initial project ideation and for reviewing the manuscript. We acknowledge ISRO for making Aditya-L1 data publicly available through the PRADAN portal, the NOAA SWPC for real-time space weather data access, the NASA SDO team for live solar imagery APIs, and the open-source communities behind PyTorch, SunPy, and Astropy.
